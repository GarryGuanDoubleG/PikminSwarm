...
public class SwarmFlockSystem : JobComponentSystem
{
    ...
    struct PikminData
    {
        ...
        [ReadOnly] public ComponentDataArray<SwarmFlockFormation> flock;
    ...
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
        ...
        var jobHandler = SwarmControllerJob.Schedule(pikCount, 32, inputDeps);
        ...
        return flockJob.Schedule(_pikminData.Length, 32, jobHandler);        
    }
}
